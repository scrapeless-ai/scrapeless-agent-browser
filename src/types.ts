...
export interface LaunchCommand extends BaseCommand {
  ...
  // Scrapeless session ID to connect to existing session
  sessionId?: string;
}
...
export type Command =
  ...
  | ConfigListCommand
  | ConfigRemoveCommand
  | ScrapelessCreateCommand
  | ScrapelessSessionsCommand
  | ScrapelessStopCommand
  | ScrapelessStopAllCommand
  | ScrapelessLiveCommand;
...
export interface ConfigListCommand extends BaseCommand {
  action: 'config_list';
}

export interface ConfigRemoveCommand extends BaseCommand {
  action: 'config_remove';
  key: string;
}

// Scrapeless session management commands
export interface ScrapelessCreateCommand extends BaseCommand {
  action: 'scrapeless_create';
  sessionName?: string;
  sessionTtl?: number;
...
export interface ScrapelessSessionsCommand extends BaseCommand {
  action: 'scrapeless_sessions';
}

export interface ScrapelessStopCommand extends BaseCommand {
  action: 'scrapeless_stop';
  taskId: string;
}

export interface ScrapelessStopAllCommand extends BaseCommand {
  action: 'scrapeless_stop_all';
}

export interface ScrapelessLiveCommand extends BaseCommand {
  action: 'scrapeless_live';
  taskId?: string;
}
