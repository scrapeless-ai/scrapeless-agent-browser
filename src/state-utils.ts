 ...
 * Located at ~/.scrapeless-scraping-browser/sessions/
 */
export function getSessionsDir(): string {
  return path.join(os.homedir(), '.scrapeless-scraping-browser', 'sessions');
}
...
export function getAutoStateFilePath(sessionName: string, sessionId: string): string | null {
  ...
  // The daemon reads SCRAPELESS_BROWSER_SESSION_NAME from environment which
